...
public class ServerTCP { 
      ...
      while(true) { 
         ...
         while ((recieveMessageSize = in.read(byteBuffer)) != -1){
            ...
            if (operationIn == 170) {
               ...
               totalLength = (short) (4 + resultBytes.length);
            }
            else if (operationIn == 85) {
               short vLength = numVowels(result);
               
               resultBytes[0] = (byte)(vLength & 0xff);
               resultBytes[1] = (byte)((vLength >> 8) & 0xff);
            ...
            for (int i = 0; i < resultBytes.length; i++) {
               ...
               System.out.println("byteBuffer[4+i] = " + resultBytes[i]);
            }
   ...
   public static short numVowels(String input) {
      short result = 0;
